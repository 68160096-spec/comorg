...
1. (5.1 Semiconductor Main Memory (หน่วยความจำหลักแบบเซมิคอนดักเตอร์))
2. (5.2 Error Correction (การแก้ไขข้อผิดพลาด))
3. (5.3 DDR DRAM (แรมแบบ DDR))
4. (5.4 Flash Memory (หน่วยความจำแฟลช))
5. ( 5.5 Newer Nonvolatile Solid-State Memory Technologies)
